...
class EstablishmentRepository implements RepositoriesInterface
{
    ...
    {
        return Establishment::with(['region.parent','images','features.icon','rules','pricePackages.icon','pricePackages.currency','specifications','unavailabilityDays'])->withAvg('reviews', 'rating')->where('is_verified','=',true)->findOrFail($id);
    }
    ...
    {
       return Establishment::with(['region.parent','images','features.icon','rules','pricePackages.icon','pricePackages.currency','specifications'])->withAvg('reviews', 'rating')->findOrFail($id);
    }
