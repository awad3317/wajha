<div>
    ...
    <div class="container pt-4">
        ...
        <div
            ...
            <h3 class="text-md-left d-none d-md-block mb-md-2 ">إدارة الباقات</h3>
        </div>


        @if ($showForm)
            <div class="card mb-4 shadow-sm border-primary rounded-4 ">
                <div class="card-header ">
                    <i class="fas fa-gift mr-2"></i> {{ $isEdit ? 'تعديل الباقة' : 'إضافة باقة جديدة' }}
                        ...
                        <div class="row g-4 ">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-pill overflow-hidden">
                                    ...
                                    <select wire:model.defer="is_active" class="form-control  border-0">
