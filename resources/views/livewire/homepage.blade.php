                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    <thead class="table-light">
                                        <tr><th>التاريخ</th><th>عدد الحجوزات</th></tr>
                                    </thead>
                                    <tbody>
                                        @foreach($bookingsChart as $row)
                                            <tr>
                                                <td><i class="fas fa-calendar-day text-primary"></i> {{ $row->date }}</td>
                                                <td>{{ $row->total }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="col-md-6">
                        <div class="card card-outline card-success">
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    <thead class="table-light">
                                        <tr><th>النوع</th><th>عدد المنشآت</th></tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    @foreach($latestAds as $a)
                                        <li class="list-group-item"><i class="fas fa-ad text-warning"></i> {{ $a->title }}</li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(document.getElementById('bookingsChart'), {
                ...
                options: {
                    ...
                    plugins: {
                        title: { display: true, text: "إحصائية الحجوزات", font: { size: 16 } },
                        tooltip: { rtl: true }
                    },
            ...
            new Chart(document.getElementById('typesChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['#28a745', '#ffc107', '#dc3545', '#17a2b8', '#6f42c1', '#e83e8c', '#fd7e14']
                    }]
                },
                options: {
                    responsive: true,
                    maintainAspectRatio: false,
                    plugins: {
                        title: { display: true, text: "أنواع المنشآت", font: { size: 16 } },
                        tooltip: { rtl: true }
                    },
                    scales: { y: { beginAtZero: true } }
                }
            ...
            new Chart(document.getElementById('usersChart'), {
                ...
                options: {
                    ...
                    maintainAspectRatio: false,
                    plugins: {
                        title: { display: true, text: "توزيع المستخدمين", font: { size: 16 } },
                        tooltip: { rtl: true }
                    }
                }
            });
