<div>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center my-2">
            @if (!$showForm && !$isEdit)
                <button wire:click="create" class="btn btn-primary text-left">إضافة الأيقونة</button>
            @endif
            <h3 class="text-left">إدارة الايقونات</h3>
        </div>
        @if ($showForm || $isEdit)
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4 mb-2">
                                <div class="input-group input-group-xl shadow-sm overflow-hidden">
                                    <input type="file" wire:model="iconFile"
                                ...
                                @if ($iconFile)
                                    <div class="mt-2 text-center">
                                        <img src="{{ $iconFile->temporaryUrl() }}" alt="معاينة" width="40"
                                            height="40" style="object-fit: cover; border-radius: 4px;">
                                    </div>
                                @elseif ($icon)
                                    <div class="mt-2 text-center">
                                        <img src="{{ url($icon) }}" alt="الأيقونة الحالية" width="40"
                                            height="40" style="object-fit: cover; border-radius: 4px;">
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="input-group input-group-xl shadow-sm overflow-hidden">
                                    <input type="text" class="form-control border-0 text-right"
                                        placeholder="...ابحث باسم ايقونة" wire:model.debounce.300ms.live="search">
                                    <span class="input-group-text bg-white border-0"><i
                    ...
                    <tbody>
                        @forelse ($packages as $package)
                            <tr>
                                ...
                                <td>
                                    @if ($package->icon)
                                        <img src="{{ url($package->icon) }}" alt="package Icon" width="60"
                                            height="60">
                                    @else
                                        —
                                    @endif
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info mb-1" wire:click="edit({{ $package->id }})">
