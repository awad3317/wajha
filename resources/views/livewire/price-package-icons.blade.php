<div>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center my-2">
            ...
            <h3 class="fw-bold text-primary mb-2 mb-sm-0 text-center text-sm-start d-none d-sm-block">إدارة الايقونات</h3>
                 @if (!$showForm && !$isEdit)
                                        ...
                                        @if ($package->icon)
                                            <div class="d-flex justify-content-center">
                                                <img src="{{ url($package->icon) }}" alt="أيقونة الباقة"
                                                    class="rounded  border-3 border-primary p-1" width="150"
                                                    height="100"
