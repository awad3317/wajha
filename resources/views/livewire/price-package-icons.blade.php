<div>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center my-2">
            @if (!$showForm && !$isEdit)
                <button wire:click="create" class="btn btn-primary add-btn text-left">إضافة الأيقونة</button>
            @endif
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-lg shadow-sm rounded-2 overflow-hidden">
                            <label class="input-group-text btn btn-primary text-white border-0 py-3" style="cursor: pointer;">
                            ...
                            <span class="form-control text-right bg-light py-3">
                                @if($iconFile) {{ $iconFile->getClientOriginalName() }}
                                @elseif($icon) تم اختيار ملف مسبقاً
                                @else لم يتم اختيار ملف
                                @endif
                            </span>
                        </div>
                        ...
                        <tr>
                            <td colspan="3" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <p class="text-muted small mt-2">يمكنك إضافة باقة جديدة باستخدام زر الإضافة</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
